...
const AuthenticationsService = require('./services/' +
                  'postgres/AuthenticationsService');
...
const CollaborationsService = require('./services/' +
                  'postgres/CollaborationsService');
